            ...
            <div className="contact__content">
                ...
                <div className="contact__info">
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">aryanjain9453@gmail.com</span>
                    ...
                    <div className="contact__card">
                        ...
                        <span className="contact__card-data">790-365----</span>
                    ...
                    <div className="contact__card"> 
                        ...
                        <span className="contact__card-data">@cid_lite_13</span>

                        <a href="https://www.instagram.com/cid_lite_13?igsh=bDNncWk2dHB4dm84" className="contact__button">Write me
                            <i className="bx bx-right-arrow-alt contact__button-icon"></i>
                        </a>
                    </div>
                </div>
